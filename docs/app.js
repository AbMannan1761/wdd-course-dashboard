// WDD Course Dashboard - Client-side Logic (Navigational LMS flow)
...
const classSummaries = {
  1: "ওয়েব ডিজাইন ও ডেভেলপমেন্টের বেসিক ক্লাস। এতে ওয়েব ডিজাইন কী, একজন ডিজাইনার ও ডেভেলপারের ভূমিকা ও কাজের ক্ষেত্র এবং পার্থক্য আলোচনা করা হয়েছে। এইচটিএমএল-৫ (HTML5) এর বেসিক সিনট্যাক্স, হেডার, বডি স্ট্রাকচার, হেডিং ট্যাগ (h1-h6) এবং টেক্সট এডিটর (Sublime/VS Code) ও ব্রাউজার পরিচিতি নিয়ে আলোচনা করা হয়েছে।",
  ...
  12: "বুটস্ট্র্যাপ (Bootstrap 5) রেসপন্সিভ সিএসএস ফ্রেমওয়ার্ক পরিচিতি। বুটস্ট্র্যাপ কিভাবে ইনস্টল ও লিংক করতে হয়, গ্রিডシステム (Containers, Rows, Columns) কিভাবে রেসপন্সিভ কাজ করে এবং বুটস্ট্র্যাপের বিভিন্ন কন্টেন্ট ও বেসিক কম্পোনেন্টসমূহের প্র্যাকটিস।",
  ...
  15: "সিএসএস অ্যানিমেশন এবং অ্যানিমেট প্লাগইন এর ব্যবহার। `@keyframes` ব্যবহার করে কাস্টম সিএসএস অ্যানিমেশন তৈরি ও চালানো। Animate.css প্লাগইন ব্যবহার করে সহজে অসাধারণ অ্যানিমেশন ইফেক্ট দেওয়ার নিয়ম।",
  ...
  20: "জাভাস্ক্রিপ্ট (JavaScript) পরিচিতি। জাভাস্ক্রিপ্টের আউটপুট মেথড, সিনট্যাক্স, ভেরিয়েবল (let, const), অপারেটর, ডাটা টাইপ, ফাংশন, অবজেক্ট, ইভেন্টস, স্ট্রিং মেথড এবং নাম্বার মেথড নিয়ে বিস্তারিত প্র্যাকটিকাল আলোচনা।",
  ...
  23: "জেকুয়েরি দিয়ে আকর্ষণীয় অ্যানিমেশন তৈরি। `animate()` মেথড, অ্যানিমেশন স্টপ করা, জেকুয়েরি চেইনিং ও কলব্যাক ফাংশন। সিএসএস ক্লাস পরিবর্তন করা (addClass, removeClass, toggleClass) এবং জেকুয়েরি প্লাগইন ব্যবহার করে রেসপন্সিভ স্লাইডার ইন্টিগ্রেশন।",
  ...
  25: "সার্ভার সাইড প্রোগ্রামিং ল্যাঙ্গুয়েজ পিএইচপি (PHP) এর পরিচিতি ক্লাস। লোকালহোস্ট সেটআপ (XAMPP), পিএইচপি সিনট্যাক্স, ভেরিয়েবল, কন্ডিশনাল স্টেটমেন্ট (if/else), লুপ (for/foreach/while) এবং পিএইচপি কাস্টম ও ফাংশনের ব্যবহার।",
  26: "পিএইচপি ও ডাটাবেস এর প্রথম ক্লাস। পিএইচপি দিয়ে ডাইনামিক ওয়েবসাইট বানানোর কনসেপ্ট, লোকাল ডাটাবেস (MySQL) এবং পিএইচপি অ্যাডমিন প্যানেল ড্যাশবোর্ড তৈরি। পিএইচপি ও ডাটাবেস কানেকশন করা এবং এসকিউএল (SQL) কোয়েরি দিয়ে ডাটা ইন্সার্ট, ভিউ ও ডিলিট করা।",
  ...
  28: "পিএইচপি-র আধুনিক ফ্রেমওয়ার্ক লারাভেল (Laravel) পরিচিতি। কম্পোজার ব্যবহার করে লারাভেল মাইগ্রেশন ও ইনস্টলেশন, আর্টিসান (Artisan) কমান্ডস, লারাভেলের প্রজেক্ট ফোল্ডার স্ট্রাকচার এবং ব্লেড টেমপ্লেটিং (Blade Templating) ইঞ্জিনের বেসিক পরিচিতি।",
  ...
  31: "ওয়ার্ডপ্রেস (WordPress) পরিচিতি। ডোমেইন-হোস্টিং ও লোকালহোস্টে ওয়ার্ডপ্রেস ইনস্টলেশন প্রসেস, ডাটাবেস কানেকশন এবং ওয়ার্ডপ্রেস ড্যাশবোর্ডের সব অপশন নিয়ে বিস্তারিত আলোচনা।",
  ...
  34: "ফ্রিল্যান্সিং মার্কেটপ্লেস আপওয়ার্ক (Upwork) পরিচিতি। আপওয়ার্কে অ্যাকাউন্ট তৈরি, প্রোফাইল আপডেট ও প্রফেশনাল পোর্টফোলিও আপলোড, কাঙ্খিত কাজ খুঁজে বের করা, কভার লেটার এবং বিডিং টেকনিক।",
  35: "ডোমেইন ও হোস্টিং পরিচিতি এবং লাইভ সার্ভার সেটআপ। cPanel ব্যবহার করার নিয়ম, ডাটাবেস তৈরি এবং ক্লাসের লোকাল এইচটিএমএল প্রজেক্ট অথবা ওয়ার্ডপ্রেস প্রজেক্ট সরাসরি হোস্টিং সার্ভারে আপলোড করা।",
  36: "কোর্সের বিদায়ী ক্লাস। ফাইনাল প্রজেক্ট মূল্যায়ন এবং শিক্ষার্থীদের তৈরি করা ওয়েবসাইটগুলোর লাইভ ডেমনস্ট্রেশন প্রদর্শন। ফাইনাল পরীক্ষা গ্রহণ এবং বিদায় অনুষ্ঠান।"
};
...
const cheatsheets = {
  ...
  5: [
    { title: "সিএসএস লিংক", desc: "এইচটিএমএল ফাইলে সিএসএস ফাইল যুক্ত করা।", code: "<link rel=\"stylesheet\" href=\"css/style.css\">" },
...
function fetchCourseData() {
  fetch('course_data.json')
    ...
    .then(data => {
      courseData = data;
      renderClassGrid(data);
      renderSidebarClassList(data);
      updateOverallProgress();
    })
    .catch(err => {
      console.error('Error fetching course data:', err);
      const gridContainer = document.getElementById('class-grid-container');
...
// Render 36 Class Grid on HOME VIEW
function renderClassGrid(data) {
  ...
  data.forEach(cls => {
    ...
    // Get first two topics as preview
    const topicsPreview = cls.syllabus.slice(0, 2).map(t => `<li>${t}</li>`).join('');

    card.innerHTML = `
      <div class="card-status-badge ${isCompleted ? 'completed' : ''}">
        ${isCompleted ? '<i class="fa-solid fa-circle-check"></i> সম্পন্ন' : '<i class="fa-regular fa-circle"></i> অসম্পূর্ণ'}
      </div>
      <div class="card-content">
        <span class="card-class-number">Class ${String(cls.id).padStart(2, '0')}</span>
        <h3 class="card-class-title">${cls.syllabus[0] || 'টপিক লোড হচ্ছে...'}</h3>
        <ul class="card-topics-preview">
          ${topicsPreview || '<li>কোনো সিলেবাস টপিক দেওয়া নেই।</li>'}
        </ul>
      </div>
      <div class="card-footer">
        <div class="card-icons">
          ${hasVideo ? '<i class="fa-solid fa-circle-play active-icon" title="ভিডিও লেকচার আছে"></i>' : '<i class="fa-solid fa-circle-play"></i>'}
          ${hasCode ? '<i class="fa-solid fa-code active-icon" title="কোড ফাইল আছে"></i>' : '<i class="fa-solid fa-code"></i>'}
        </div>
        <button class="btn btn-card-action">শুরু করুন <i class="fa-solid fa-arrow-right"></i></button>
      </div>
    `;

    // Click to select class and open detail view
    card.addEventListener('click', () => selectClass(cls.id));
    
    // Double click to toggle completed status
    card.addEventListener('dblclick', (e) => {
      e.stopPropagation(); // Prevent opening the class
      toggleClassCompleted(cls.id);
    });
...
// Render Sidebar List for DETAIL VIEW (Quick Switcher on Desktop)
function renderSidebarClassList(data) {
  ...
  data.forEach(cls => {
    ...
    item.innerHTML = `
      ...
      <div class="class-item-icons">
        ${hasVideo ? '<i class="fa-solid fa-play active-icon"></i>' : '<i class="fa-solid fa-play" style="opacity: 0.1"></i>'}
        ${hasCode ? '<i class="fa-solid fa-code active-icon"></i>' : '<i class="fa-solid fa-code" style="opacity: 0.1"></i>'}
      </div>
    `;
...
// Select Class and Switch to DETAIL VIEW
function selectClass(classId) {
  ...
  const sidebarItem = document.getElementById(`sidebar-item-${classId}`);
  if (sidebarItem) sidebarItem.classList.add('active');

  // Switch Views: Hide Home, Show Detail
  ...
  document.getElementById('selected-class-title').textContent = cls.syllabus[0] || 'সিলেবাস টপিক';
...
// Open video file in Windows Media Player/VLC via Local server API
...
function toggleClassCompleted(classId) {
  ...
  // Re-render views
  renderClassGrid(courseData);
  renderSidebarClassList(courseData);
  updateOverallProgress();

  // If currently viewing the toggled class, update card styling
  const activeGridCard = document.getElementById(`class-card-${classId}`);
  if (activeGridCard) {
    if (completed.includes(classId)) {
      activeGridCard.classList.add('completed');
    } else {
      activeGridCard.classList.remove('completed');
    }
  }
}
...
// Back to Home view from Detail view
function backToHomeGrid() {
  // Stop playing video (both native & youtube)
  const nativePlayer = document.getElementById('native-video-player');
  nativePlayer.pause();
  nativePlayer.src = '';
...
function setupEventListeners() {
  ...
  // Back Button
  document.getElementById('btn-back-to-grid').addEventListener('click', backToHomeGrid);
